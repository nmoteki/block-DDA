...
VectorXcd MBT_fft_mvp(const VectorXi& n,const int& f, const VectorXcd& Au_til, const VectorXcd& p_hat, fftw_plan& plan_fwd, fftw_plan& plan_inv)
{
     ...
     ***************************************************************************************/
     ...
     fftw_execute_dft(plan_fwd,reinterpret_cast<fftw_complex*>(&p_hatz[0]), reinterpret_cast<fftw_complex*>(&p_hatz[0]));
     VectorXcd q_hatz= Au_til.cwiseProduct(p_hatz);
     fftw_execute_dft(plan_inv,reinterpret_cast<fftw_complex*>(&q_hatz[0]), reinterpret_cast<fftw_complex*>(&q_hatz[0]));
     q_hatz= q_hatz/fft_length;
